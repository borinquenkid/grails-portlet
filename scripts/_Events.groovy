...
eventPackagingEnd = {
    try {
        ...
        def portletsPath = basedir + File.separator + "grails-app" + File.separator + "portlets"
        def searchPath = "file:${portletsPath}/**/*Portlet.groovy"
        def customModes = [:]
        def userAttributes = [:]
            ...
            def xml = xmlWriter.bind {
                'portlet-app'(version: portletVersion,
                    ...
                    portletFiles.each {portletClassFile ->
                        def className = portletClassFile.file.absolutePath - (portletsPath + File.separator) - '.groovy'
